...
const Login = ({ onLoginSuccess ,onSwitchToRegister}) => {
    ...
    const handleLoginSubmit = async (e) => {
        ...
        try {
            ...
            setErrorMessage(error.message || "Invalid credentials. Authentication failed.");
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-100">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleLoginSubmit}>
                    ...
                    <div className="text-center text-sm text-slate-600">
                        ...
                        <span onClick={onSwitchToRegister} className="font-semibold text-slate-950 hover:underline cursor-pointer transition-all">
                            Register now
                        </span>
                    </div>
                </form>
